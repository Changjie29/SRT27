...
import { TECH_ROUTE_STEPS } from '@/data/content';
    ...
    <section id="techroute" className="w-full py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-4 md:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          <div className="mb-3 text-sm font-medium text-wheat">技术路线</div>
            ...
            {TECH_ROUTE_STEPS.map((step, i) => {
              ...
              return (
                ...
                >
                  ...
                  {i < TECH_ROUTE_STEPS.length - 1 && <ArrowRight className="h-4 w-4 text-muted-foreground/40" />}
                </motion.div>
              );
            })}
          </div>
